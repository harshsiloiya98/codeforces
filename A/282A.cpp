...
A statement in language Bit++ is a sequence, consisting of exactly one operation and one 
variable x. The statement is written without spaces, that is, it can only contain characters 
...
and exactly one variable x (denoted as letter «X»). Thus, there are no empty statements. The 
