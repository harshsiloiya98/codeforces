...
write a simple program. The program was supposed to do the following: in the given string, 
...
Input
The first line represents input string of Petya's program. This string only consists of 
uppercase and lowercase Latin letters and its length is from 1 to 100, inclusive.
